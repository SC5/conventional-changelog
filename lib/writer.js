...
function getCommitLink(repository, pull) {
  return repository ?
    util.format(PULL_REQUEST, pull, repository, pull) :
    util.format(COMMIT, pull);
}
    ...
    components.forEach(function(name) {
      ...
      section[name].forEach(function(commit) {
        stream.write(util.format(
          ...
          prefix, commit.subject, options.commitLink(commit.pullrequest)
        ));
